      ...
      <Footnote>
        <p className="text-xs text-gray-500">
          ...
          <ol className="pl-3 list-decimal list-outside">
            ...
            <li>
              Apple Pencil (รุ่นที่ 2) จำหน่ายแยกต่างหาก สามารถใช้งานร่วมกับ
              iPad Pro รุ่น 11 นิ้ว (รุ่นที่ 1 หรือใหม่กว่า), iPad Pro 12.9 นิ้ว
            ...
            <li>
              ...
              สำหรับรายละเอียดในการรองรับ 5G และ LTE
              โปรดติดต่อผู้ให้บริการของคุณ และดูที่ apple.com/th/ipad/cellular
            </li>
            <li>
