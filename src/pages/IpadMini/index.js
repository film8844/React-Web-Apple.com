    ...
    <>
            ...
            <div className="sticky top-0">
              ...
              <div className="mt-20 grid grid-cols-3 gap-3 mb-5 text-center">
                <div className="flex flex-col items-center">
                  ...
                  <p className="mt-1 text-xs font-semibold">จัดส่งฟรี</p>
                </div>
                <div className="flex flex-col items-center">
                  <svg
                    viewBox="0 0 35 35"
      ...
      <Footnote>
        ...
        <ol className="pl-3 list-decimal list-outside text-xs text-gray-500">
          ...
          <li>
            Apple Pencil (รุ่นที่ 2) จำหน่ายแยกต่างหาก สามารถใช้งานร่วมกับ iPad
            Pro รุ่น 11 นิ้ว (รุ่นที่ 1 หรือใหม่กว่า), iPad Pro 12.9 นิ้ว
            (รุ่นที่ 3 หรือใหม่กว่า) และ iPad Air (รุ่นที่ 4)
          </li>
          <li>
            จำเป็นต้องมีแผนบริการข้อมูล, 5G, 4G LTE และการโทรผ่าน Wi‑Fi
            มีให้บริการในบางประเทศผ่านผู้ให้บริการเครือข่ายบางแห่งเท่านั้น
            ความเร็วขึ้นอยู่กับปริมาณงานตามหลักทฤษฎีและแตกต่างกันตามสภาวะของไซต์และเครือข่าย
            สำหรับรายละเอียดในการรองรับ 5G และ LTE โปรดติดต่อผู้ให้บริการของคุณ
            และดูที่ apple.com/th/ipad/cellular
          </li>
          <li>
        ...
        <p className="text-xs text-gray-500">
          ...
          หนึ่งการสมัครสมาชิกต่อกลุ่มการแชร์กันในครอบครัว ข้อเสนอมีระยะเวลา 3
          เดือนหลังการเปิดใช้งานอุปกรณ์ที่เข้าเกณฑ์
          แผนบริการจะมีการต่ออายุโดยอัตโนมัติจนกว่าจะยกเลิก
          อาจมีข้อจำกัดและข้อกำหนดอื่นๆ
        </p>
      </Footnote>
        ...
        <div className="flex bg-gray-100 rounded-2xl p-5 mb-5">
          <p className="text-xs">
            <span className="font-bold">
              ใส่ความเป็นคุณให้กับ iPad mini ได้ฟรี
            </span>{' '}
