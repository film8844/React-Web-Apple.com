  ...
  return (
    <FAQAccordion>
      <QuestionItem>
        ...
        <Answer>
          <p>
            Apple Pencil (รุ่นที่ 2) โดยสามารถจับคู่ได้แบบไร้สาย
            และยึดติดกับตัวเครื่องด้วยแม่เหล็กเพื่อชาร์จและจัดเก็บได้
          </p>
        </Answer>
      </QuestionItem>
      <QuestionItem>
      ...
      <QuestionItem>
        ...
        <Answer>
          <p>
            เมื่อต้องการใช้งาน 5G คุณต้องใช้งาน iPad
            กับผู้ให้บริการเครือข่ายโทรศัพท์ที่มีบริการ 5G
            โดยที่ผู้ให้บริการเครือข่ายโทรศัพท์บางรายอาจกำหนดให้คุณต้องมีแผนบริการ
            5G หรือเปลี่ยน SIM ใหม่
            โปรดสอบถามข้อมูลเพิ่มเติมจากผู้ให้บริการเครือข่ายโทรศัพท์ของคุณ
          </p>
        </Answer>
      </QuestionItem>
      <QuestionItem>
