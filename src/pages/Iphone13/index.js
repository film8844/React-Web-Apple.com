      ...
      <Footnote>
        ...
        <ol className="pl-3 list-decimal list-outside text-xs text-gray-500">
          <li>
            ...
            นิ้ว (iPhone 13 mini, iPhone 12 mini), 6.06 นิ้ว (iPhone 13, iPhone
            13 Pro, iPhone 12) หรือ 6.68 นิ้ว (iPhone 13 Pro Max) ในแนวทแยง
            พื้นที่สำหรับการดูจริงมีขนาดน้อยกว่า
          </li>
          <li>
        ...
        <p className="text-xs text-gray-500">
          ...
          ธันวาคม
          รายได้ดังกล่าวจะได้รับการส่งมอบให้กับกองทุนโลกเพื่อการรับมือกับ
          COVID-19
        </p>
        <p className="mt-1 text-xs text-gray-500">
          iPhone 13 mini และ iPhone 13 มีความสามารถในการทนน้ำ น้ำที่กระเด็นใส่
          และฝุ่น
