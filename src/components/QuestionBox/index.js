    ...
    <div>
      <div className="w-full md:w-3/5 mx-auto p-8">
        <div className="tab w-full overflow-hidden">
          <input className="absolute opacity-0" id="tab-multi-zero" type="checkbox" name="tabs" />
          <label className="block p-5 leading-normal cursor-pointer text-2xl font-bold" for="tab-multi-zero">คำถามที่พบบ่อย</label>
          <div className="tab-content overflow-hidden leading-normal">
            <div className="tab w-full overflow-hidden text-s">
              <input className="absolute opacity-0 " id="tab-multi-one" type="checkbox" name="tabs" />
              <label className="block p-5 leading-normal cursor-pointer font-semibold" for="tab-multi-one">ทำไมจึงควรซื้อ iPhone แบบที่ไม่มีซิมบน apple.com</label>
              <div className="tab-content overflow-hidden leading-normal">
                <p className="p-5">iPhone เครื่องใหม่ของฉันจะเป็นเครื่องปลดล็อคหรือไม่
            ...
            <div className="tab w-full overflow-hidden text-s ">
              ...
              <label className="block p-5 leading-normal cursor-pointer font-semibold" for="tab-multi-two">การถ่ายโอนข้อมูลและตั้งค่า iPhone เครื่องใหม่นั้นง่ายจริงมั้ย</label>
              <div className="tab-content overflow-hidden leading-normal">
                <p className="p-5">
            ...
            <div className="tab w-full overflow-hidden text-s ">
              ...
              <label className="block p-5 leading-normal cursor-pointer font-semibold bold" for="tab-multi-three">iPhone เครื่องใหม่ของฉันจะเป็นเครื่องปลดล็อคหรือไม่</label>
              <div className="tab-content overflow-hidden leading-normal">
                <p className="p-5">
            ...
            <div className="tab w-full overflow-hidden text-s ">
              ...
              <label className="block p-5 leading-normal cursor-pointer font-semibold" for="tab-multi-four">iPhone ใช้งานได้ทั่วโลกหรือไม่</label>
              <div className="tab-content overflow-hidden leading-normal">
                <p className="p-5">
            ...
            <div className="tab w-full overflow-hidden text-s ">
              <input className="absolute opacity-0" id="tab-multi-five" type="checkbox" name="tabs" />
              <label className="block p-5 leading-normal cursor-pointer font-semibold" for="tab-multi-five">ผู้ให้บริการเครือข่ายไร้สายรายใดบ้างที่ให้บริการ 5G</label>
              <div className="tab-content overflow-hidden leading-normal">
                <p className="p-5">
            ...
            <div className="tab w-full overflow-hidden text-s ">
              <input className="absolute opacity-0" id="tab-multi-six" type="checkbox" name="tabs" />
              <label className="block p-5 leading-normal cursor-pointer font-semibold" for="tab-multi-six">ตัวเลือกในการจัดส่งมีอะไรบ้าง และฉันจะได้รับสินค้าเมื่อไหร่</label>
              <div className="tab-content overflow-hidden leading-normal">
                <p className="p-5">
            ...
            <div className="tab w-full overflow-hidden text-s ">
              <input className="absolute opacity-0" id="tab-multi-seven" type="checkbox" name="tabs" />
              <label className="block p-5 leading-normal cursor-pointer font-semibold" for="tab-multi-seven">ฉันสามารถส่งคืน iPhone ได้หรือไม่</label>
              <div className="tab-content overflow-hidden leading-normal">
                <p className="p-5">
